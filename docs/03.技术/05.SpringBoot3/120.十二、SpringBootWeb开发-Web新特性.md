---
title: 十二、SpringBootWeb开发-Web新特性
date: 2023-06-08 21:35:53
permalink: /pages/fab67a/
categories:
  - 技术
  - SpringBoot3
tags:
...
//配置过一个属性 spring.mvc.problemdetails.enabled=true 才能开启这个功能
...
![image](https://cdn.statically.io/gh/747721653/picx-images-hosting@master/springboot/image.4xjbce08v7c0.webp)
...
- **RequestPredicate**：定义请求规格：请求谓语。请求方式（GET、POST）、请求参数
